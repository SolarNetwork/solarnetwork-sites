...
sn.chart.energyIOBarChart = function(containerSelector, chartConfig) {
	...
	function drawTimeAggregateBands(timeAggregateData) {
		...
		var aggBands = svgAggBandGroup.selectAll("line").data(bandTicks, keyX);
		...
		var aggBandLabels = svgAggBandLabelGroup.selectAll("text").data(bandTicks, keyX);
	...
	function drawTimeAggregates(timeAggregateData) {
		...
		var aggLabels = svgAggGroup.selectAll("text").data(labelTicks, keyX);
