 ...
 */
SNAPI.authURLPath = function(url) {
	var a = document.createElement('a');
	a.href = url;
	var path = a.pathname;
	
	// handle query params, which must be sorted
	var params = SNAPI.parseURLQueryTerms(a.search);
 ...
 */
SNAPI.requestJSON = function(url, callback, method) {
	...
	$.ajax({
		...
		beforeSend: function(xhr) {
			...
			var path = SNAPI.authURLPath(url);
